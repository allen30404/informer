...
data_list = ['place_1.csv','place_2.csv','place_3.csv','place_4.csv','place_5.csv','place_6.csv','place_7.csv','place_8.csv','place_9.csv'] #檔名
data_capacity = [177.735,580.0,493.92,387.0,182.16,203.06,368.42,251.685,248.0] #裝置容量
data_dict = {
    'filename':data_list,
